...
class CategoryController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect(route('category.index'))->with(['insert' => 'Kategori Baru Ditambahkan!']);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect(route('category.index'))->with(['update' => 'Kategori Diperbaharui!']);
    }
    ...
    public function destroy($id)
    {
        ...
        if ($category->child_count == 0 && $category->product_count == 0) {
            $category->delete();
            return redirect(route('category.index'))->with(['delete' => 'Kategori Dihapus!']);
        }
