...
<head>
    ...
    <!-- CSS -->
    <link href="{{asset('/front/css/email/style.css')}}" rel="stylesheet">
    <link href="{{asset('/front/css/email/phone-responsive.css')}}" rel="stylesheet">
    <link href="{{asset('/front/css/email/tablet-responsive.css')}}" rel="stylesheet">
    <link href="{{asset('/front/css/email/desktop-responsive.css')}}" rel="stylesheet">
    ...
    <script src="{{asset('/front/js/back-nav.js')}}"></script>
