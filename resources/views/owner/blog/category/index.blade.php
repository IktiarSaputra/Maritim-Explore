        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-titlectext-center" id="exampleModalLabel">Add Category</h5>
                        ...
                        <table class="table nowrap" id="basic-data-table" width="100%">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{$k->name}}</td>
                                    <td>
                                        <a class="btn btn-sm btn-warning" href="/owner/category/edit/{{$k->id}}"><i
                                                class="mdi mdi-pencil"></i></a>
                                        <a class="btn btn-sm btn-danger delete" href="/owner/category/hapus/{{$k->id}}"><i
