...
<body>
    ...
    <h1 class="text-center mb-3">Daftar Vaksinasi di indonesia</h1>
    <p class="text-center description">Daftar vaksinasi Ini berdasarkan kemenkes </p>

    <div class="container-fluid" id="data">
        <section class="center slider">
                <div class="card">
                    <div class="card-img-overlay text-white d-flex flex-column">
                        <h3 class="card-title">{{ number_format($data['sasaranvaksinsdmk']) }}</h3>
                        <p>Sasaran Vaksin SDMK</p>
                    </div>
                </div>
                <div class="card">
                    <div class="card-img-overlay text-white d-flex flex-column">
                        <h3 class="card-title">{{ number_format($data['sasaranvaksinpetugaspublik']) }}</h3>
                        <p>Sasaran Vaksin Petugas Publik</p>
                    </div>
                </div>
                <div class="card">
                    <div class="card-img-overlay text-white d-flex flex-column">
                        <h3 class="card-title">{{ number_format($data['sasaranvaksinlansia']) }}</h3>
                        <p>Sasaran Vaksin Lansia</p>
                    </div>
                </div>
                <div class="card">
                    <div class="card-img-overlay text-white d-flex flex-column">
                        <h3 class="card-title">{{ number_format($data['totalsasaran']) }}</h3>
                        <p>Total Sasaran</p>
                    </div>
                </div>
        </section>
    ...
    <div class="container" id="vaksinasi">
        <img src="{{('front/image/vaksinasi-1.jpg')}}" width="100%" alt="Sinovac"> 
        <h1 class="mt-4">Sinovac</h1>
        <p class="mt-3">Vaksin COVID-19 Sinovac menggunakan inactivated virus atau metode virus yang telah dilemahkan. Berdasarkan laporan terakhir uji klinis vaksin COVID-19 Sinovac memicu antibodi usai empat pekan suntik.</p>
        <img src="{{('front/image/vaksinasi-2.jpg')}}" width="100%" alt="Pfizer"> 
        <h1 class="mt-4">Pfizer</h1>
        <p class="mt-3">Vaksin COVID-19 Pfizer memiliki efektivitas 95 persen di hasil akhir uji klinis yang dilaporkan. Vaksin COVID-19 ini menggunakan teknologi baru mRNA dan perlu disimpan dalam suhu minus 70-80 derajat Celcius karena mudah degradasi.</p>
        <img src="{{('front/image/vaksinasi-3.jpg')}}" width="100%" alt="Moderna"> 
        <h1 class="mt-4">Moderna</h1>
        <p class="mt-3">Vaksin COVID-19 Moderna juga masuk dalam daftar vaksin COVID-19 yang akan digunakan Indonesia. Sama seperti Pfizer, Moderna termasuk vaksin COVID-19 yang menggunakan teknologi baru mRNA</p>
    </div>
