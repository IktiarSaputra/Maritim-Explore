                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <select name="status" class="form-control" required>
                                ...
                                <option value="0" {{ $product->status == '0' ? 'selected':'' }}>Habis</option>
                            </select>
                        ...
                        <div class="form-group">
                            ...
                            <p style="font-size: 12px;color:red"><strong>*Biarkan kosong jika tidak ingin mengganti gambar*</strong></p>
